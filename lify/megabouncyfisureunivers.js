const startMegaBounceFisureUnivers = function (cell) {
    return calcMegaBounceFisureUnivers(neighborsOfMegaBounceFisureUnivers(cell));
}

const neighborsOfMegaBounceFisureUnivers = function (cell) {
    let neighbors = [];
...
const calcMegaBounceFisureUnivers = function (neighbors) {
    let total = 0;
